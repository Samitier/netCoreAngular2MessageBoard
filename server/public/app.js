...
/***/ function(module, exports, __webpack_require__) {
	...
	var message_component_ts_1 = __webpack_require__(34);
	var draggable_item_directive_ts_1 = __webpack_require__(35);
	var safe_pipe_ts_1 = __webpack_require__(36);
	var global_vars_service_ts_1 = __webpack_require__(33);
	var app_http_service_ts_1 = __webpack_require__(32);
	var web_api_service_ts_1 = __webpack_require__(31);
	    ...
	    AppModule = __decorate([
	        core_1.NgModule({
	            ...
	            declarations: [
	                ...
	                message_component_ts_1.MessageComponent,
	                draggable_item_directive_ts_1.DraggableItemDirective,
	                safe_pipe_ts_1.SafePipe
	            ],
	            providers: [
	                global_vars_service_ts_1.GlobalVarsService,
	                app_http_service_ts_1.AppHttpService,
	                web_api_service_ts_1.WebApiService
	            ],
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AppComponent = (function () {
	    function AppComponent(_webApiService, _globals) {
	        this._webApiService = _webApiService;
	        this._globals = _globals;
	        this.isCreating = false;
	    }
	    AppComponent.prototype.ngOnInit = function () {
	        var _this = this;
	        this._webApiService.getMessages().then(function (messages) { return _this.messages = messages; });
	    };
	    AppComponent.prototype.addNewMessage = function (event) {
	    ...
	    AppComponent.prototype.exitEditing = function () {
	        if (this.isCreating) {
	            this.isCreating = false;
	            this.messages.splice(this.messages.length - 1, 1);
	        }
	    };
	    AppComponent.prototype.onMessageCreated = function (isCorrect) {
	        if (!isCorrect)
	            this.messages.splice(this.messages.length - 1, 1);
	        this.isCreating = false;
	    };
	    AppComponent = __decorate([
	        ...
	        __metadata('design:paramtypes', [web_api_service_ts_1.WebApiService, global_vars_service_ts_1.GlobalVarsService])
	    ], AppComponent);
	    return AppComponent;
	}());
...
/***/ function(module, exports, __webpack_require__) {
	...
	var WebApiService = (function () {
	    ...
	    WebApiService.prototype.getMessages = function () {
	        return this._http.get(this._apiUrl + 'messages');
	    };
	    WebApiService.prototype.putMessage = function (message) {
	        return this._http.put(this._apiUrl + 'messages' + "/" + message.id, message);
	    };
	    WebApiService.prototype.postMessage = function (message) {
	        return this._http.post(this._apiUrl + 'messages', message);
	    };
	    WebApiService.prototype.deleteMessage = function (id) {
	    };
	    WebApiService = __decorate([
	        core_1.Injectable(), 
	        __metadata('design:paramtypes', [app_http_service_ts_1.AppHttpService])
	    ], WebApiService);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AppHttpService = (function () {
	    ...
	    AppHttpService.prototype._extractData = function (response) {
	    ...
	    AppHttpService.prototype._handleError = function (error) {
	        var errMsg = "API error -> " + error.json().message;
	        console.error(errMsg);
	        return Promise.reject(errMsg);
	    };
	    AppHttpService.prototype._buildJSON = function (message) {
	        var obj = {};
	        if (message.controls) {
	    ...
	    AppHttpService.prototype._onInit = function () {
	    ...
	    AppHttpService.prototype.get = function (route) {
	        return this._http.get(route, this._options)
	            .toPromise()
	            .then(this._extractData)
	            .catch(this._handleError);
	    };
	    AppHttpService.prototype.put = function (route, message) {
	        return this._http.put(route, this._buildJSON(message), this._options)
	            .toPromise()
	            .then(this._extractData)
	            .catch(this._handleError);
	    };
	    AppHttpService.prototype.post = function (route, message) {
	        var json = this._buildJSON(message);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MessageComponent = (function () {
	    function MessageComponent(_globals, _webApiService) {
	        this._globals = _globals;
	        this._webApiService = _webApiService;
	        this.onMessageCreated = new core_1.EventEmitter();
	    ...
	    MessageComponent.prototype.ngOnInit = function () {
	        ...
	        if (this.message.isCreating)
	            ...
	            delay = (Math.random() * this._globals.timeOfRefresh).toFixed(2);
	        this.appearAnimation = "scaleInAnim 0.5s " + delay + "s forwards";
	        if (typeof this.message.rotation == 'number')
	            this.rotation = "rotateZ(" + this.message.rotation + "deg)";
	    };
	    MessageComponent.prototype.onUpdatePosition = function (newPosition) {
	        if (!this.message.isCreating) {
	    ...
	    MessageComponent.prototype.onSendMessage = function () {
	        var _this = this;
	        if (this.message.isCreating && !this.isSending) {
	            this.isSending = true;
	            this._webApiService.postMessage(this.message).then(function (response) {
	                _this.message = response;
	                _this.onMessageCreated.emit(true);
	                _this.isSending = false;
	            }).catch(function (error) {
	                _this.onMessageCreated.emit(false);
	            });
	    ...
	    __decorate([
	        core_1.Output(), 
	        __metadata('design:type', Object)
	    ], MessageComponent.prototype, "onMessageCreated", void 0);
	    MessageComponent = __decorate([
	        ...
	        __metadata('design:paramtypes', [global_vars_service_ts_1.GlobalVarsService, web_api_service_ts_1.WebApiService])
	    ], MessageComponent);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var core_1 = __webpack_require__(4);
	var DraggableItemDirective = (function () {
	    function DraggableItemDirective(_elem, _renderer) {
	        this._elem = _elem;
	        this._renderer = _renderer;
	    ...
	    DraggableItemDirective.prototype.ngOnInit = function () {
	        this._renderer.setElementClass(this._elem.nativeElement, "noselect", true);
	    };
	    DraggableItemDirective.prototype.onMouseDown = function (event) {
	        var elemx = Number(this._elem.nativeElement.style.left.replace('px', '')), elemy = Number(this._elem.nativeElement.style.top.replace('px', ''));
	        this.dragging = true;
	        this.offsetY = event.y - elemy;
	        this.offsetX = event.x - elemx;
	    };
	    DraggableItemDirective.prototype.onMouseMove = function (event) {
	        if (this.dragging) {
	    ...
	    DraggableItemDirective.prototype.onMouseUp = function (event) {
	    ...
	    __decorate([
	        core_1.Output(), 
	        __metadata('design:type', Object)
	    ], DraggableItemDirective.prototype, "onDrop", void 0);
	    __decorate([
	        core_1.HostListener('mousedown', ['$event']), 
	        __metadata('design:type', Function), 
	        __metadata('design:paramtypes', [Object]), 
	        __metadata('design:returntype', void 0)
	    ], DraggableItemDirective.prototype, "onMouseDown", null);
	    __decorate([
	        core_1.HostListener('document:mousemove', ['$event']), 
	        __metadata('design:type', Function), 
	        __metadata('design:paramtypes', [Object]), 
	        __metadata('design:returntype', void 0)
	    ], DraggableItemDirective.prototype, "onMouseMove", null);
	    __decorate([
	        core_1.HostListener('document:mouseup', ['$event']), 
	        __metadata('design:type', Function), 
	        __metadata('design:paramtypes', [Object]), 
	        __metadata('design:returntype', void 0)
	    ], DraggableItemDirective.prototype, "onMouseUp", null);
	    DraggableItemDirective = __decorate([
	        core_1.Directive({
